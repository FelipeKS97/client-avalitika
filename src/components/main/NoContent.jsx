...
export const NoContent = props => (
  <div style={styles}>
    <Typography style={{color: '#1a1c4acf', marginTop:'1rem'}} variant="h5" component="h2" gutterBottom>
        {props && props.title || 'Ainda nada por aqui.'}
    </Typography>
    <svg
    ...
    >
      <defs>
        <linearGradient id="a" osbpaint="solid">
          <stop offset={0} stopColor="#1A1C4A" />
        </linearGradient>
        <path
      ...
      />
      <path d="M185 195h330" fill="none" stroke="#1A1C4A" strokeWidth={2} />
      <path
