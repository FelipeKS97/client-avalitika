      ...
      <div>
        ...
        { this.props.element.hasOwnProperty('content') &&
          <div className="form-group">
            <label className="control-label">Texto exibido:</label>
        ...
        {canHavePageBreakBefore &&
          <div className="form-group">
            <label className="control-label">Opções Visuais</label>
            <div className="checkbox">
              <label>
        ...
        { this.props.element.hasOwnProperty('options') && null
          // <div className="form-group">
